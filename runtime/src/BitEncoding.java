...
public class BitEncoding {
    ...
    public static String encodeAsString(byte[] data) {
        return encodeBytes(data)[0];
    }

    public static byte[] decodeString(String s) {
        return decodeBytes(new String[]{s});
    }
     ...
     */
    private static byte[] encode8to7(byte[] data) {
     ...
     */
    private static String[] splitBytesToStringArray(byte[] data) {
